...
import { type Chat, chatSchema, isChat } from './chat.mjs';
...
describe('Chat', () => {
  ...
  describe('isChat', () => {
    ...
    test('detects a valid Chat with one thread', () => {
      expect(isChat(actualChat2)).toBe(true);
    });
...
const actualChat2: Chat = {
  ...
  users: [
    {
      ...
      email: 'dave@qccareerschool.com',
      present: true,
      last_seen_timestamp: 1786381645,
      type: 'customer',
      session_fields: [ { school: 'QC Design School' } ],
      created_at: '2026-08-10T16:27:52.607369Z',
      last_visit: {
      ...
      customer_last_event_created_at: '2026-08-10T17:07:25.105004Z',
    },
    {
      id: 'info@qccareerschool.com',
      name: 'Arnold',
  ...
  thread: {
    id: 'TJ7KHC5WKD',
    created_at: '2026-08-10T17:07:25.105000Z',
    active: true,
    properties: {
      routing: {
        continuous: true,
        group_status_at_start: 'not_accepting_chats',
        idle: false,
        last_transfer_timestamp: 1786381645,
        pinned: true,
        start_url: 'https://www.qcdesignschool.com/',
        unassigned: true,
      },
    ...
    user_ids: [ '22a0dc3c-f11e-42ba-aeeb-11dd810eb621' ],
    events: [
      {
        id: 'TJ7KHC5WKD_1',
        custom_id: '3gqrhcem64b',
        visibility: 'all',
        created_at: '2026-08-10T17:07:25.105004Z',
        author_id: '22a0dc3c-f11e-42ba-aeeb-11dd810eb621',
        properties: {
          lc2: { form_type: 'prechat' },
          source: { client_id: 'c5e4f61e1a6c3b1521b541bc5c5a2ac5' },
